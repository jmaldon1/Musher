...
PYBIND11_MODULE(musher_python, m) {
  ...
  m.def("hpcp_from_peaks", &_HPCPFromPeaks, "description", py::arg("peaks"), py::arg("size") = 12,
  ...
  m.def("hpcp", &_HPCP, "description", py::arg("frequencies"), py::arg("magnitudes"), py::arg("size") = 12,
        py::arg("reference_frequency") = 440.0, py::arg("harmonics") = 0, py::arg("band_preset") = true,
        py::arg("band_split_frequency") = 500.0, py::arg("min_frequency") = 40.0, py::arg("max_frequency") = 5000.0,
        py::arg("_weight_type") = "squared cosine", py::arg("window_size") = 1.0, py::arg("sample_rate") = 44100.,
        py::arg("max_shifted") = false, py::arg("non_linear") = false, py::arg("_normalized") = "unit max");
  ...
  m.def("detect_key", &_DetectKey, "description", py::arg("normalized_samples"), py::arg("sample_rate") = 44100.,
        ...
        py::arg("frame_size") = 4096, py::arg("hop_size") = 512,
        py::arg("window_type_func") = py::cpp_function(BlackmanHarris62dB), py::arg("max_num_peaks") = 0,
        py::arg("hop_size") = .5);
}
